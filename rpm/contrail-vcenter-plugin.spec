...
wget --directory-prefix=../target http://repo.maven.apache.org/maven2/org/apache/httpcomponents/httpclient/4.2.1/httpclient-4.2.1.jar
...
install -p -m 755 ../target/httpclient-4.2.1.jar %{buildroot}/usr/share/contrail-vcenter-plugin/lib
