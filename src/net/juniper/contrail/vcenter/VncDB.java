        ...
        for (VirtualNetwork vn : apiObjs) {
            try {
                ...
                if (vn.getParent() == null)
                    s_logger.error("In readVirtualNetworks:vn.getParent() is NULL");
                s_logger.error("In readVirtualNetworks:" + vn.getName());
                s_logger.error("In readVirtualNetworks parent Uuid:" + vn.getParentUuid());
