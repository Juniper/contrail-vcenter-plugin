...
public class VNetworkListReqHttpHandler implements HttpHandler {

    private final String styleSheet = "/universal_parse.xsl";

    public VNetworkListReqHttpHandler() {
        VCenterHttpServices.newInstance().registerHandler("/Snh_vNetworksTotal", this);
    }
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        VNetworkListReq req = new VNetworkListReq(t.getRequestURI());
        VNetworkListResp resp = new VNetworkListResp(req);
        resp.writeObject(s);
